...
{
    public class ThemesInfringementService
    {

        public static HttpWebResponse GetSensitiveJsonData(string url, string jsonbodyRequest, string themesServiceAuthorizationToken, string themesAppServiceHeader,string themesHost)
        {
            ...
            {
                throw new ArgumentNullException("jsonBodyRequest");
            }

            //TODO: Modify/access headers from config
            HttpWebRequest req = (HttpWebRequest)WebRequest.Create(url);
            req.Headers.Add($"X-Authorization: {themesServiceAuthorizationToken}");
            req.Headers.Add($"X-Application: {themesAppServiceHeader}"); 
            req.Method = "POST";
            ...
            byte[] postByteArray = encoding.GetBytes(jsonbodyRequest);
